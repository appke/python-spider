...
#				desc: '//cd.jd.com/description/channel?skuId=1540037&mainSkuId=1540037&cdn=2',
...
#				productImgs = productSoup.find('div', id='spec-list').select('img')
				...
				searchResult = re.search(r'//cd.jd.com/description/channel\?skuId=(.*?)&mainSkuId=(.*?)&cdn=2', productResponse.text)
				skuId = searchResult.group(1)
				mainSkuId = searchResult.group(2)
